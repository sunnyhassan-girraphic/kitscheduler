...
urlpatterns = [
    ...
    path("sonnet-boxes/", views.sonnet_list_view, name="sonnet_list"),
    path("sonnet-boxes/new/", views.sonnet_create_view, name="sonnet_create"),
    path("sonnet-boxes/<int:sonnet_id>/edit/", views.sonnet_edit_view, name="sonnet_edit"),
    path("sonnet-boxes/<int:sonnet_id>/delete/", views.sonnet_delete_view, name="sonnet_delete"),
