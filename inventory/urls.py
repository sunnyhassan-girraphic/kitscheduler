...
urlpatterns = [
    ...
    path("assets/bulk-add/", views.asset_bulk_wizard_view, name="asset_bulk_wizard"),
    path("api/assets/bulk-next-id/", views.asset_bulk_next_id, name="asset_bulk_next_id"),
    ...
    path("kits/archive/", views.kit_archive_view, name="kit_archive"),
    ...
    path("settings/db-backup/", views.db_backup_view, name="db_backup"),
    path("settings/db-restore/", views.db_restore_view, name="db_restore"),
    path("settings/csv-import/", views.csv_import_view, name="csv_import"),
    path("api/settings/db-info/", views.db_info_view, name="db_info"),
    ...
    path("api/dashboard/widgets/save/", views.dashboard_widgets_save, name="dashboard_widgets_save"),
